...
def parse_args(args):
    ...
    # Evaluation
    parser.add_argument('--evaluate_memoria', action='store_true', help='eval 3d only for memoria')
    ...
    parser.add_argument('--is_shard', default='', help='the ckpt is distributed so it saves')
    parser.add_argument('--save_pt', default='', help='Save model as pt from deepspeed')
    parser.add_argument('--individual_test', action='store_true', help='test for individual')
    parser.add_argument('--memory_test', action='store_true', help='test for individual')
    parser.add_argument('--saved_before', action='store_true', help='saved_before')
    parser.add_argument('--Experiment_detail', default='', help='The detail of the experiment')
    #Embedd the dataset
    parser.add_argument('--embedd_Dataset', action='store_true', help='creates an embedded dataset in the same folder of the original')
